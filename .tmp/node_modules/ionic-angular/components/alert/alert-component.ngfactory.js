...
export function viewFactory_AlertCmp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AlertCmp === null)) {
        (renderType_AlertCmp = viewUtils.createRenderComponentType('/Users/MacBook/alarm/node_modules/ionic-angular/components/alert/alert-component.d.ts class AlertCmp - inline template', 0, import12.ViewEncapsulation.None, styles_AlertCmp, {}));
    }
